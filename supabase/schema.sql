...
values
  ...
  ('carb_news', 'https://ww2.arb.ca.gov/rss.xml', 'state', 'california', 2, 'weekly', '{air,climate,transportation}', 'rss', null, true, 'CARB newsroom — announces CCI/Moyer/FARMER solicitations and rulemaking.'),
  ('capcoa', 'https://www.capcoa.org/feed/', 'state', 'california', 2, 'weekly', '{air,climate}', 'rss', null, true, 'Association of all 35 CA air districts — district grant and program announcements.'),
  ...
  ('sjvapcd_grants', 'https://ww2.valleyair.org/grants/', 'state', 'california', 2, 'weekly', '{air,transportation}', 'scrape', null, false, 'SJVAPCD grant programs (Moyer, FARMER, Clean Green Yard Machines...); no RSS — needs scrape adapter.'),
  ('baaqmd_grants', 'https://www.baaqmd.gov/funding-and-incentives', 'state', 'california', 2, 'weekly', '{air,transportation}', 'scrape', null, false, 'BAAQMD funding & incentives; no RSS — needs scrape adapter.'),
  ('scaqmd_grants', 'https://www.aqmd.gov/home/programs', 'state', 'california', 2, 'weekly', '{air,transportation}', 'scrape', null, false, 'SCAQMD programs/incentives; /rss serves HTML index — needs scrape adapter or sub-feed investigation.'),
